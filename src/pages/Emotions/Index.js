...
const emotions = [
    ...
    { id: 9, image: require(`../../assets/emotions/Tedio.png`), hoverImage: require(`../../assets/emotionsHover/TedioHover.png`), value: 'Tédio', className:'tedio', color: '68,63,185', gradient: '0,0,0' },
  ];
